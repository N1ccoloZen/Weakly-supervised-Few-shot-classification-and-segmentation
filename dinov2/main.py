...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgsize', type=int, default=700, help='image size')  # not variable
    ...
    trainer = Trainer(strategy='ddp_find_unused_parameters_false',  # DistributedDataParallel
